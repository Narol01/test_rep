...
class CompanyImplTest {
    ...
    void setUp() {
        ...
        employees[0] = new Manager(101, "John", "Smith", 45, 160, 5000, 5);
        employees[1] = new SalesManager(102,"Anna", "Black", 36, 160, 25000, 0.1);
        employees[2] = new SalesManager(103,"Thomas", "White", 28, 160, 30000, 0.1);
        employees[3] = new Worker(104, "Gans", "Bauer", 30, 160, 5);
    }
    ...
    void findEmployee() {
        ...
        assertEquals( employees[1], company.findEmployee(102));
